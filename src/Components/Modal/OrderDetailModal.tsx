          ...
          <div className="order-detail__status-panel">
            ...
            <div className="order-status-select">
              ...
              >
                {detailedOrder && (
                  <option value={detailedOrder.status}>
                    {getOrderStatusMeta(detailedOrder.status).label} (current)
                  </option>
                )}
              ...
              <button
                ...
                disabled={isSaving || currentStatus === detailedOrder?.status}
              >
                {isSaving ? "Saving..." : "Update"}
              </button>
              {availableNextStatuses.length === 0 && (
                <small style={{ display: "block", color: "#9ca3af" }}>
                  This is a final status — no further transitions available.
                </small>
              )}
            </div>
          </div>
        ...
        <div className="order-modal__content">
          {isLoading ? (
            ...
            <>
              ...
              {/* Order Info Grid */}
              <div className="order-section">
                <h3 className="order-section__title">Details</h3>
                <div className="order-info-grid">
                  ...
                  <div className="order-info-grid__item">
                    <span className="order-info-grid__label">Total Items</span>
                    <span className="order-info-grid__value">
                      {detailedOrder.orderItems?.reduce(
                        (t, i) => t + i.quantity,
                        0,
                  ...
                  <div className="order-info-grid__item">
                    <span className="order-info-grid__label">Vendors</span>
                    <span className="order-info-grid__value">
                      {vendors.length}
                    </span>
                  </div>
                      ...
                      <div className="vendor-card__header">
                        <div>
                          ...
                          <span className="vendor-card__district">
                            {vendor.vendorDistrict || "Unknown District"}
                          </span>
                        </div>
                        {same !== null && (
                          <span
                          ...
                          >
                            {same ? "Same District" : "Cross District"}
                          </span>
                        )}
                      </div>
                            ...
                            <div key={item.id} className="vendor-card__item">
                              ...
                              <div className="vendor-card__item-pricing">
                                ...
                                <span className="vendor-card__item-unit">
                                  Rs. {Number(item.price).toFixed(2)} x{" "}
                                  {item.quantity}
                                </span>
                              </div>
                            </div>
                      ...
                      <div className="vendor-card__footer">
                        <div className="vendor-card__footer-left">
                          ...
                          <span className="vendor-card__footer-shipping">
                            Rs.{" "}
                            {vendorShipping
                              ? vendorShipping.shippingFee.toFixed(2)
                              : "0.00"}
                          </span>
                        </div>
              ...
              {/* Order Summary */}
              <div className="order-section">
                <h3 className="order-section__title">Summary</h3>
                <div className="order-summary-box">
                  ...
                  <div className="order-summary-row">
                    <span className="order-summary-row__label">
                      Total shipping ({vendors.length} vendor
                      {vendors.length !== 1 ? "s" : ""})
                    </span>
                    <span className="order-summary-row__value">
                  ...
                  {detailedOrder && Number(detailedOrder.discountTotal) > 0 && (
                    <div className="order-summary-row">
                      <span className="order-summary-row__label">Discount</span>
                      <span className="order-summary-row__value">
                        - Rs. {Number(detailedOrder.discountTotal).toFixed(2)}
                      </span>
                    </div>
                  )}
                        ...
                        >
                          ...
                          {entry.previousStatus && (
                            <span style={{ color: "#6b7280" }}>
                              {" "}
                              (from{" "}
                              {getOrderStatusMeta(entry.previousStatus).label})
                            </span>
                          )}
