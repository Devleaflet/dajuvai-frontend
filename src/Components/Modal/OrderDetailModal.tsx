            ...
            >
                ...
                >
                    {isLoading ? (
                        ...
                        <>
                            <div
                                className="order-modal__customer-info"
                                style={{
                                    display: "flex",
                                    alignItems: "center",
                                    gap: "15px",
                            ...
                            >
                                ...
                                <div className="order-modal__customer-name">
                                    ...
                                    <p
                                        className="order-modal__order-id"
                                        style={{
                                            fontSize: "14px",
                                            color: "#666",
                                            margin: "4px 0 0",
                            ...
                            <div
                                className="order-modal__details-grid"
                                style={{
                                    display: "grid",
                            ...
                            >
                                ...
                                <div
                                    className="order-modal__detail-item order-modal__detail-item--full"
                                ...
                                >
                                    ...
                                    >
                                        {detailedOrder
                                            ...
                                            : `${order.streetAddress || ""}, ${order.town || ""}, ${order.state || ""}, ${order.country || ""}`.replace(
                                                  /^,\姚s*|,\s*$/g,
                                                  "",
                                              ) || "N/A"}
                                    </span>
