...
> = {
  ...
  pending: {
    ...
    message: "Your payment is being processed. We will update you shortly.",
    iconBg: "#fef3c7",
    iconColor: "#d97706",
  },
  failed: {
  ...
  cancelled: {
    ...
    message: "Your payment was cancelled. No amount was charged.",
    iconBg: "#fee2e2",
    iconColor: "#dc2626",
  },
};
...
const PaymentStatusCard: React.FC<PaymentStatusCardProps> = ({
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text(
      `Shipping Fee: Rs ${toNumber(orderData.shippingFee).toFixed(2)}`,
      10,
      (y += 10),
    );
    doc.text(
      `Total: Rs ${toNumber(orderData.totalPrice).toFixed(2)}`,
      10,
      (y += 10),
    );
            ...
            <div className="psc-section__grid">
              {merchantTxnId && (
                <div className="psc-section__item">
                  <span className="psc-section__label">
          ...
          <div className="psc-section">
            ...
            <div className="psc-section__grid">
              ...
              <div className="psc-section__item">
                ...
                <span className="psc-section__value">
              ...
              <div className="psc-section__item">
                ...
                <span
                  className={`psc-badge psc-badge--${orderData.paymentStatus.toLowerCase()}`}
                >
              ...
              <div className="psc-section__item">
                ...
                <span
                  className={`psc-badge psc-badge--${orderData.status.toLowerCase()}`}
                >
                  {orderData.status}
                </span>
              </div>
